...
public class YourService extends KiboRpcService {
    ...
    private void logPosition(){
        Point p = api.getRobotPosition();
        double x = p.getX();
        double y = p.getY();
        double z = p.getZ();
        Log.i(TAG, "Current Position: (" + x + ", " + y + ", " + z + ", " + ")" );
    }

    private void logQuaternion(){
        Quaternion q = api.getRobotOrientation();
        double x = q.getX();
        double y = q.getY();
        double z = q.getZ();
        double w = q.getW();
        Log.i(TAG, "Current Orientation: (" + x + ", " + y + ", " + z + ", " + w + ")" );
    }
